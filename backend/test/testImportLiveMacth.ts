...
import BaseApi                              from "../src/liveScoreApi/api/BaseApi";
import { GenericApiResponse }               from "../src/liveScoreApi/interface/API/GlobalInterface";
import * as MatchApiResponse                from "../src/liveScoreApi/interface/API/MatchInterface";
...
import * as CompetitionMongo                from "../src/database/mongodb/models/Competition";
