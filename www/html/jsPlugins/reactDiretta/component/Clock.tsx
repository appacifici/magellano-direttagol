...
function getTime(d:Date) {
    ...
    const ret:Ret = {
        firstSecond:  secs.charAt(0),
        secondSecond: secs.charAt(1),
        firstMinute:  mins.charAt(0),
        secondMinute: mins.charAt(1),
        firstHour:    hours.charAt(0),
        secondHour:   hours.charAt(1)
    };
    
    return ret;
}

const Clock = ({ country, timezone }: { country: string; timezone: number }) => {
