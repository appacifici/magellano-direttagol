...
function MatchesBoard() {    
    ...
    return( 
        <>                    
            <Container fluid="md" className="matchBoard rounded p3 mt-4">
                {
                    matches.map( match => <>
                        <Row key={match.competition.id} className='championship'>
                            <Col xs={1} md={1}><i className="bi bi-star"></i></Col>
                            <Col xs={10} className='text-center mt-2'>
